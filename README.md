...
CREATE INDEX idx_consulta_estudiante
    ON consulta(estudiante_id);
...
CREATE TABLE recomendacion (
    id CHAR(36) PRIMARY KEY,
    consulta_id CHAR(36) NOT NULL UNIQUE,
...
CREATE TABLE fuente (
    id CHAR(36) PRIMARY KEY,
    recomendacion_id CHAR(36) NOT NULL,
    curso_id CHAR(36) NOT NULL,
...
CREATE INDEX idx_fuente_recomendacion
    ON fuente(recomendacion_id);
